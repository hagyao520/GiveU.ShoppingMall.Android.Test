...
public class AndroidSystem_Handler {
	 ...
	 * @throws Exception 
	 */
	public void androidKeycode(Test_Step step) throws Exception {
	 ...
	 * @throws Exception 
	 */
	public void androidReturn(Test_Step step) throws Exception {
		System.out.println("『正常测试』开始执行: " + "<" +step.getDesc() + ">");
	 ...
	 * @throws Exception 
	 */
	public void androidOpennb(Test_Step step) throws Exception {
		System.out.println("『正常测试』开始执行: " + "<" +step.getDesc() + ">");
	 ...
	 * @throws Exception 
	 */
	public void androidScroll(Test_Step step) throws Exception {
		System.out.println("『正常测试』开始执行: " + "<" +step.getDesc() + ">");
	 ...
	 * @throws Exception 
	 */
	public void androidSwipe(Test_Step step) throws Exception {
		System.out.println("『正常测试』开始执行: " + "<" +step.getDesc() + ">");
	 ...
	 * @throws Exception 
	 */
	public void adbSwipe(Test_Step step) throws Exception{ 
		System.out.println("『正常测试』开始执行: " + "<" +step.getDesc() + ">");
		step.getAndroidDriver().manage().timeouts().implicitlyWait(10000, TimeUnit.MILLISECONDS);
