...
public class Selenium_Util {
	...
	public static WebElement getElement(Test_Step step) throws Exception{
		...
		WebElement e = step.getAndroidDriver().findElement(By.xpath(step.getLocator()));
		return e;
	}
	
	public static WebElement getElement1(Test_Step step) throws Exception{
		WebElement e = step.getAndroidDriver().findElement(By.xpath(step.getValue()));
		return e;
	}
