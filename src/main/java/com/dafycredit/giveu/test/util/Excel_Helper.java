...
public class Excel_Helper {
    ...
    public static void main(String[] args) throws Exception {
        String excelPath = Config_Util.getProperty("testdata.path", Constants.CONFIG_COMMON);
        Excel_Helper.read(excelPath);
        List<String> values = Excel_Helper.getCellContentByIndexs(0, "a2", "E8", "E9");
        
        values = Excel_Helper.getCellContentByIndexs(0, "A1", "E8", "E9", "D1", "E8", "E9", "D1");
