...
public class QQShopping_Shopping {
	
	private static RunUnit_Service runService;
		
	@BeforeTest
	private void stup() throws Exception{
		Test_Unit testunit = AndroidTestXmlParse_Service.parse3("src/main/java/QQShoppingTestCaseXml/QQShopping_Shopping.xml");
		runService = new RunUnit_Service(testunit);
		System.out.println("-----------------------------------【即有钱包QQ购物流程的测试场景点】-----------------------------------");
	}
