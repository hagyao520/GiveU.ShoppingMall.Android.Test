...
public class WeChatShopping_Repayment {
	
	private static RunUnit_Service runService;
		
	@BeforeTest
	private void stup() throws Exception{
		Test_Unit testunit = AndroidTestXmlParse_Service.parse3("src/main/java/WeChatShoppingTestCaseXml/WeChatShopping_Repayment.xml");
		runService = new RunUnit_Service(testunit);
		System.out.println("-----------------------------------【即有钱包微信购物还款流程的测试场景点】-----------------------------------");
	}
